...
An extension that adds an interactive timeline to your AI chat conversations. **Now supports ChatGPT, DeepSeek, Microsoft Copilot, and Google Gemini!**
...
- **🌐 Multi-Platform Support**: Works seamlessly on **ChatGPT**, **DeepSeek**, **Microsoft Copilot**, and **Google Gemini**.
...
> After installation, open any ChatGPT, DeepSeek, Copilot, or Gemini conversation and the timeline will appear on the right.
